    ...
    children: [
      {
        ...
        name: "Stacks using",
        children: [
          { type: "file", name: "C#", href: null, accent: "text-sky-300" },
          { type: "file", name: ".NET", href: null, accent: "text-sky-300" },
          { type: "file", name: "WinForms", href: null, accent: "text-sky-300" },
          { type: "file", name: "SQL Server", href: null, accent: "text-sky-300" },
          { type: "file", name: "Dapper", href: null, accent: "text-sky-300" },
          { type: "file", name: "T-SQL", href: null, accent: "text-sky-300" },
          { type: "file", name: "Next.js", href: null, accent: "text-sky-300" },
          { type: "file", name: "React", href: null, accent: "text-sky-300" },
          { type: "file", name: "TypeScript", href: null, accent: "text-sky-300" },
          { type: "file", name: "Tailwind CSS", href: null, accent: "text-sky-300" },
          { type: "file", name: "Supabase", href: null, accent: "text-sky-300" },
          { type: "file", name: "Git", href: null, accent: "text-sky-300" },
          { type: "file", name: "GitHub", href: null, accent: "text-sky-300" },
          { type: "file", name: "Vercel", href: null, accent: "text-sky-300" },
        ],
      },
